          ...
          <div className="lg:w-4/12 lg:pr-24 mb-10 lg:mb-0">
            {testimonialContent.heading.subTitle && (
              <span
                ...
                before:left-0 before:top-0 before:bottom-0 before:-z-10 text-gray-500"
              >
                {testimonialContent.heading.subTitle}
              </span>
            )}
            {testimonialContent.heading.title && (
              <h2 className="text-heading text-2xl lg:text-4xl font-bold mb-5 text-white">
                {testimonialContent.heading.title}
              </h2>
            )}

            {testimonialContent.heading.title && (
              <p className=" text-body leading-relaxed mb-10 text-gray-500">
